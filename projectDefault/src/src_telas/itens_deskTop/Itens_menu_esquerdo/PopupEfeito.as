package src_telas.itens_deskTop.Itens_menu_esquerdo 
{
	 ...
	 * @author ...
	 */
	public class PopupEfeito extends Sprite
	{
		...
		{
			fundo = new Image(Assets.getTexture("popup_efeito_bg") );
			...
			{
				quadro[q] = new Image(Assets.getTexture("popup_efeito_quadro"));
